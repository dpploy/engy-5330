...
/// ConvectiveTerm class inherits from Kernel class
class ConvectiveTerm : public Kernel
{
public:
   ...
   */
  ConvectiveTerm(const InputParameters & parameters);
...
protected:
  ...
  /// The variables which holds the value for the ConvectiveTerm coefficient
  const RealVectorValue _velocity;
  const Real _voidFraction;
