...
{
  return (_grad_fractionVapor[_qp](0) *(_rho_v-_rho_l)*_velocityMixture[_qp]+ \
  (_fractionVapor[_qp]*_rho_v+(1-_fractionVapor[_qp])*_rho_l)*_grad_velocityMixture[_qp](0)) *_test[_i][_qp];
}
