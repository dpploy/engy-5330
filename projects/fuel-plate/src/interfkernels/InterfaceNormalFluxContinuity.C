...
registerMooseObject("FuelPlateApp", InterfaceNormalFluxContinuity);

InputParameters
InterfaceNormalFluxContinuity::validParams()
{
  InputParameters params = InterfaceKernel::validParams();
  params.addRequiredParam<Real>("diffCoeff", "Primary diffusivity.");
  params.addRequiredParam<Real>("diffCoeffNeighbor", "Neighbor diffusivity.");
  return params;
}
